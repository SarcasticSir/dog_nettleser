...
- Match result screen
- Mobile-browser support from day one (responsive layout, touch input, reconnect-safe session handling)
...
- Native mobile apps (the first release must still work well in mobile browsers)
- Voice chat
- Public matchmaking
- Ranked ladder
- Cosmetics/store
...
- Test at minimum for desktop wide layout and narrow mobile layout.
